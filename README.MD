# Anki Template Theme with LLM Prompt and Custom Elements

A minimal Anki card template for graduate-level study. Designed for content-heavy decks in economics, mathematics, and related fields—with full MathJax support, dark mode, and a clean two-tier callout system. Includes an LLM (AI) prompt to generate formatted cards for .txt export.

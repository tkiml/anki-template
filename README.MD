# Anki Template Theme with custom elements

A minimal, typographically considered Anki card template for graduate-level study. Designed for content-heavy decks in economics, mathematics, and related fields — with full MathJax support, dark mode, and a clean two-tier callout system. Includes LLM (AI) promt to include to generate formated cards into a txt export.
